...
function woo_add_cart_fee() { global $woocommerce; $woocommerce->cart->add_fee( __('Kode Unik', 'woocommerce'), rand(1,99) ); } add_action( 'woocommerce_before_calculate_totals', 'woo_add_cart_fee' );
