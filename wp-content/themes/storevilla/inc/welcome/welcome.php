				...
				// Get Plugin Info
					...
					public function plugin_activation_callback() {
						if ( ! current_user_can('activate_plugins') ) {
							wp_die( esc_html__( 'Sorry, you are not allowed to acivate plugins on this site.', 'storevilla' ) );
						}
					...
					public function plugin_deactivation_callback() {
						if ( ! current_user_can('activate_plugins') ) {
							wp_die( esc_html__( 'Sorry, you are not allowed to deacivate plugins on this site.', 'storevilla' ) );
						}
